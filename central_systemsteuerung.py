...
"""
Zentrale Systemsteuerung - Wrapper für PdvmCentralDatenbank
==========================================================
...
# Globale Variable für die CentralSystemsteuerung Instanz
_global_central_systemsteuerung = None

def get_global_central_systemsteuerung():
    """
    Liefert die globale CentralSystemsteuerung Instanz
    
    Returns:
        CentralSystemsteuerung: Die globale Instanz
...
def gcs():
    """
    Get Central Systemsteuerung - Eleganter Zugriff auf globale CentralSystemsteuerung
