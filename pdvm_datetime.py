...
class Pdvm_DateTime(object):
    ...
    def __setPdvmDateTime(self,pdvmddate):
        logger.info(f"🔹 PdvmDateTime wird gesetzt: {pdvmddate}")
        if pdvmddate < 1001.0:
            pdvmddate = 1001.0 
        try:
            if pdvmddate > 0:
    ...
    # --------------------------------------------------------------------
    def __calcDateToForm(self, datein, dlen=8):
        year  = 0
        month = 0
        day   = 0
...
# 
# full_ts = PdvmDateTimeUtils.PdvmDateTimeNow()  # z. B. 20250605.143210
# date_only = PdvmDateTimeUtils.PdvmDateNow()    # z. B. 20250605.0
# time_only = PdvmDateTimeUtils.PdvmTimeNow()    # z. B. 0.143210
# 
# --------------------------------------------------------------------
