# pdvm_linear_start_new.py
# LINEARER STARTABLAUF mit neuer Systemsteuerung
"""
LINEARER STARTABLAUF:
1. Login-Fenster öffnen
2. Login validieren  
3. 2-Faktor Bestätigung (optional/vorbereitet)
4. Neue globale Systemsteuerung initialisieren
...
logging.basicConfig(
    ...
    datefmt="%Y-%m-%d %H:%M:%S",
    handlers=[
        logging.FileHandler("pdvm_linear_start_new.log", encoding="utf-8"),
...
class LinearStartManagerNew:
    ...
    def _initialize_new_global_system(self):
        ...
        try:
            # Import der FINALEN Systemsteuerung
            from pdvm_central_systemsteuerung_final import initialize_gcs, is_gcs_initialized, get_gcs
    ...
    def _start_main_application(self):
        ...
        try:
            ...
            from PDVM_Systemstart_vollständig_final import MainAppComplete
            try:
