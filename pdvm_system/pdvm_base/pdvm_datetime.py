...
from pdvm_base.pdvm_util import printMessage
...
if __name__=='__main__':
    ...
    from pdvm_base.pdvm_util import lockedWritten, multiChar, p_print, t_p_t  
    # das Wörterbuch mit den einzelnen Testelementen wurde ausgelagert
    exec
    from pdvm_base import pdvm_datetime_test
