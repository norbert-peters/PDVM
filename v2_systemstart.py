...
# -*- coding: utf-8 -*-
"""
V2.0 Hauptanwendung (Basis: pdvm_systemstart.py)

Kopie der funktionierenden Hauptanwendung für V2.0-Migration.
Menü-System und MenuHandler werden später neu implementiert (als Kommentare).
"""
...
class V2MainAppComplete(QMainWindow):
    ...
    def __init__(self):
        ...
        # Fensterkopfzeile: Mandant - Benutzername
        self.setWindowTitle(f"PDVM V2.0 - {mandant_bezeichnung} - {user_name}")
    ...
    def _show_welcome_message(self):
        ...
        <div style="text-align: center; padding: 40px;">
            <h1 style="color: #0078d4;">🎉 Willkommen im PDVM V2.0!</h1>
        ...
        try:
            ...
            if hasattr(self, 'current_view_controller') and self.current_view_controller:
                ...
                if hasattr(self.current_view_controller, 'refresh'):
                    ...
                    logger.info(f"✅ View erfolgreich aktualisiert (Stichtag aus GCS: {self.gcs.stichtag})")
                else:
            ...
            if hasattr(self, 'current_dialog') and self.current_dialog:
                ...
                if hasattr(self.current_dialog, 'refresh'):
                    ...
                    logger.info(f"✅ Dialog erfolgreich aktualisiert (Stichtag aus GCS: {self.gcs.stichtag})")
                else:
    ...
    def _perform_logout(self):
        ...
        try:
            ...
            # Starte v2_main.py in neuem Prozess (V2.0!)
