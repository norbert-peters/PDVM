...
class PdvmCentralDatenbank:
    ...
    def __init__(
        ...
        Args:
            ...
            historisch: Flag für zeitbasierte Historisierung
        """
        ...
        # Basis-Datenbankschicht initialisieren
        ...
        logger.info(f"PdvmCentralDatenbank initialisiert: {table_name}.{guid} (historisch: {historisch})")
    ...
    def create_with_data(
        ...
        Returns:
            PdvmCentralDatenbank: Instanz mit gesetzten Daten
        """
