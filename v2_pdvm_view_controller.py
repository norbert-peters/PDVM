...
from v2_pdvm_central_datenbank import PdvmCentralDatenbank  # V2: Datenbank!
from v2_central_systemsteuerung import get_gcs  # V2: GCS Import!

# V2 Filter-System (ALLE Komponenten als V2-Versionen!)
from v2_pdvm_schnellsuche_manager import SchnellsucheManager
from v2_pdvm_einfach_filter_manager import EinfachFilterManager
...
class V2PdvmViewController(QObject):
    ...
    def _initialize_matrix_manager(self):
        ...
        try:
            from v2_pdvm_view_matrix_manager import PdvmViewMatrixManager
    ...
    def _create_ui(self):
        ...
        try:
            from v2_pdvm_view_ui import PdvmViewUI
